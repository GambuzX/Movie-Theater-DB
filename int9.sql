...
Select SUM(precoOriginal) as 'Dinheiro Total ' , SUM(precoEfetivo) as  'Dinheiro Efetivo' , 100-100*SUM(precoEfetivo)/SUM(precoOriginal) as 'Percentagem De Dinheiro Descontado'
 from Pedido;
